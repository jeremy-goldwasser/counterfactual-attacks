...
import pickle
path = './results/network-snapshot-008800.pkl'
...
import pathlib
latent_dir = os.path.join(pathlib.Path().resolve(), 'projections')

data_dir = '/var/tmp/celebA/celeba/img_align_celeba_stylegan'
